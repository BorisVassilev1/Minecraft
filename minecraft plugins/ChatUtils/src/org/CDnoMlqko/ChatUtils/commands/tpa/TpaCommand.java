...
import org.CDnoMlqko.ChatUtils.scoreboard.ScoreboardDataContainer;
...
public class TpaCommand implements CommandExecutor{
	...
	public boolean onCommand(CommandSender sender, Command cmd, String label, String[] args) {
		if(sender instanceof Player)
		{
			...
			if(!ScoreboardDataManager.scoreboardData.get(reciever.getName()).hasTeleportationRequestPending)
			{
				...
				ScoreboardDataContainer recieverScoreboard = ScoreboardDataManager.scoreboardData.get(reciever.getName());
				
				recieverScoreboard.setTeleportationRequest((Player) sender);;
				recieverScoreboard.hasTeleportationRequestPending = true;
