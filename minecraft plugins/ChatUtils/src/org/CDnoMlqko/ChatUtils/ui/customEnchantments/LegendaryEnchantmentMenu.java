...
public class LegendaryEnchantmentMenu extends InventoryGUI{

	public LegendaryEnchantmentMenu() {
		super("&6LEGANDARY ENCHANTMENT", 6);
	}
	...
	public Inventory GUI(Player p) {
		...
		Utils.createItemByte(inv, Material.STAINED_GLASS_PANE, 1, 1, slot(6, 1), " " , "");
		Utils.createItemByte(inv, Material.STAINED_GLASS_PANE, 1, 1, slot(6, 2), " ", "");
		Utils.createItemByte(inv, Material.STAINED_GLASS_PANE, 1, 1, slot(6, 3), " ", "");
		Utils.createItemByte(inv, Material.STAINED_GLASS_PANE, 1, 1, slot(7, 1), " ", "");
		Utils.createItemByte(inv, Material.STAINED_GLASS_PANE, 1, 1, slot(7, 3), " ", "");
		Utils.createItemByte(inv, Material.STAINED_GLASS_PANE, 1, 1, slot(8, 1), " ", "");
		Utils.createItemByte(inv, Material.STAINED_GLASS_PANE, 1, 1, slot(8, 2), " ", "");
		Utils.createItemByte(inv, Material.STAINED_GLASS_PANE, 1, 1, slot(8, 3), " ", "");
