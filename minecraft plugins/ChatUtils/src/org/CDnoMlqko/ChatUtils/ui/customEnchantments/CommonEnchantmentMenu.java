...
public class CommonEnchantmentMenu extends InventoryGUI{

	public CommonEnchantmentMenu() {
		super("&fCOMMON ENCHANTMENT", 6);
	}
	...
	public Inventory GUI(Player p) {
		...
		Utils.createItemByte(inv, Material.STAINED_GLASS_PANE, 1, 0, slot(6, 1), " ", "");
		Utils.createItemByte(inv, Material.STAINED_GLASS_PANE, 1, 0, slot(6, 2), " ", "");
		Utils.createItemByte(inv, Material.STAINED_GLASS_PANE, 1, 0, slot(6, 3), " ", "");
		Utils.createItemByte(inv, Material.STAINED_GLASS_PANE, 1, 0, slot(7, 1), " ", "");
		Utils.createItemByte(inv, Material.STAINED_GLASS_PANE, 1, 0, slot(7, 3), " ", "");
		Utils.createItemByte(inv, Material.STAINED_GLASS_PANE, 1, 0, slot(8, 1), " ", "");
		Utils.createItemByte(inv, Material.STAINED_GLASS_PANE, 1, 0, slot(8, 2), " ", "");
		Utils.createItemByte(inv, Material.STAINED_GLASS_PANE, 1, 0, slot(8, 3), " ", "");
